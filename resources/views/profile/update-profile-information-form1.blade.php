...
<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
            ...
            <x-deprecated.label for="photo" value="{{ __('Photo') }}" />
            ...
            <x-deprecated.secondary-button class="mt-2 me-2" type="button" x-on:click.prevent="$refs.photo.click()">
                {{ __('Select A New Photo') }}
            </x-deprecated.secondary-button>

            @if ($this->user->profile_photo_path)
            <x-deprecated.secondary-button type="button" class="mt-2" wire:click="deleteProfilePhoto">
                {{ __('Remove Photo') }}
            </x-deprecated.secondary-button>
            @endif
